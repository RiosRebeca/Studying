...
import random                        # É importante importar as classes no   import math		             # início do arquivo


classe = dir(random)                 # Aqui ele vai criar uma lista com os                    print(classe)                        # elementos dentro da classe
